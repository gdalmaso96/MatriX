...
class PixelHit : public G4VHit{
	public:
		...
		inline void SetChannel(G4int val){fChannel = val;}
		...
		inline G4int GetChannel(){return fChannel;}
		...
		inline void Clear(){fNCells = 0; fChannel = 0; fNPhotoElectrons = 0; fCells.clear(); fCellTime.clear(); fPhysVol = nullptr; fDrawit = false; fPixelNumber = -1;}
